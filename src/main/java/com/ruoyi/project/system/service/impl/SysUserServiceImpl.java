...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public SysUser selectUserByUserName(String userName) {
        if (PhoneUtil.isMobile(userName)) {
            // 手机号登录
            return selectUserByPhone(userName);
        }
     ...
     */
    @Override
    public int updatePasswordByPhone(String password, String phoneNumber) {
        return userMapper.updatePasswordByPhone(password,phoneNumber);
    }
